 ...
 * @brief Declaration of the GLProjectionInfo class for managing window properties in the Asteroids application.
 */
...
namespace asteroids
{
     ...
     */
    class ASTEROIDS_DLL_EXPORT GLProjectionInfo : public entity::Entity
    {
    public:
        /**
